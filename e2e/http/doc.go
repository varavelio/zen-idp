...
// of the e2e/http/harness package. Each test file covers one complete
// product scenario, and each test runs against its own isolated instance
// with a dedicated configuration, state database, and loopback port.
//
