...
- [Self-host a container registry with Zot](./zot/) -
  Zot is a self-hosted OCI container registry. In this example its web UI is locked behind a Zen IdP sign-in through zot's generic OpenID provider, and only the demo user can browse and push to it.
