...
Every user signs in with two things they have: an identifier and a six digit code from an authenticator app. The code is a standard TOTP value, [RFC 6238](https://datatracker.ietf.org/doc/html/rfc6238), with a 30 second step and 6 digits long, generated by any authenticator: Google Authenticator, Authy, Aegis, 1Password, Bitwarden, or the one built into your password manager.
